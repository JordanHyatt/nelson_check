...
class NelsonRule:
    def __init__(self,num):
        ...
        self.num = num
        self.desc = RULES[self.num]['desc']
        self.problem = RULES[self.num]['problem']
    def __str__(self):
...
class NelsonCheck:
    def __init__(self,data,CL,LCL,UCL,exclude_rules=[]):
        self.violations = []#List Of Nelston Violation Objects
        self.result = True # Result after testing rules
        self.data=data; self.CL=CL; self.LCL=LCL; self.UCL=UCL
